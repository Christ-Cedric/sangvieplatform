...
export function AdminReports() {
  ...
  const handleExportPDF = () => {
    ...
    autoTable(doc, {
      ...
      body: [
        [t("admin.stats.donations") + " (" + t("admin.dashboard.this_month") + ")", totalDonations.toLocaleString()],
        [t("admin.users.total") + " (" + t("admin.users.active") + ")", totalDonors.toLocaleString()],
        [t("admin.hospitals.total") + " (" + t("hospital.stats.partners") + ")", totalHospitals.toString()],
        [t("admin.reports.satisfaction"), "89%"],
      ],
      theme: "striped",
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            ...
            <Typography.Body className="text-[#888888]">
              {t("admin.reports.national_overview")} - Mars 2026
            </Typography.Body>
          </div>
